        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    @if ($user->avatar)
                        <img src="{{ asset($user->avatar) ?? asset('img/avatar/user.png') }}" alt="A" class="avatar avatar-sm">
                    @else
                        <img src="{{  asset('img/avatar/user.png') }}" alt="A" class="avatar avatar-sm">
                    @endif
                    <div class="d-none d-xl-block ps-2">
                        <div class="text-white">{{ $user->prenom }} {{ $user->nom }}</div>
                        <div class="mt-1 small text-secondary">{{ $user->fonction }}</div>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    {{-- <a href="#" class="dropdown-item">Status</a> --}}
                    <a href="{{ route('profile',['user_id'=> $user->id]) }}" wire:navigate class="dropdown-item">Profile</a>
                    {{-- <a href="#" class="dropdown-item">Feedback</a> --}}
                    <div class="dropdown-divider"></div>
                    <a href="{{ route('settings',['user_id'=> $user->id]) }}" class="dropdown-item">Paramètres</a>
            ...
            @else
                <div class="nav-item ">
                    <div class="btn-list">
                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#login" >Connexion</a>
                        <a class="btn btn-light" data-bs-toggle="modal" data-bs-target="#register">Inscription</a>
                    </div>
                </div>
            @endauth
        </div>
